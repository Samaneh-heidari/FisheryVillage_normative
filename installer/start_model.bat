@ECHO OFF
TITLE FisheryVillage_normative
...
CD FisheryVillage_normative

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./FisheryVillage_normative.rs
